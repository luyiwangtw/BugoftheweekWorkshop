...
<span style="color: #FF8F00">**Exercise 1**: Copy the Website repo from Bug of the week to your own GitHub.
...
2. **Change the file type to .yml** by adding ".yml" at the end of the file.
...
However, there are some difference in syntax between the two formats and functions are available in html but not in PDF, e.g. Tabs, code buttons.

```{r eval=FALSE, include=TRUE}
output: pdf_document
```

<span style="color: #FF8F00">**Exercise 4**: Try to make one RMardown file and knit it into a PDF.
