...
_Note: You would like to save your output html files in the docs folder. To do so, you will need to change the directory in the yaml header like the following code:_
...
3. **Inside the _site.yml file** Whatever you put here will overwrite the ymal header in the separate .Rmd files. In side the file, we will specify some things including the headers, the table, the theme, and the output directory.
...
2. In the Setting, on the left table, click Page
...
4. You made it! But it will take a couple minutes till you the link starts to work.
...
1. [RMarkdown cheat sheet](https://www.rstudio.com/wp-content/uploads/2015/02/rmarkdown-cheatsheet.pdf)
2. [R Markdown: The Definitive Guide](https://bookdown.org/yihui/rmarkdown/html-document.html#table-of-contents)
3. [Tom Keaney's Introduction to R markdown](https://tomkeaney.github.io/Rmarkdown_intro/)
4. [Getting started with a RMarkdown](https://ourcodingclub.github.io/tutorials/rmarkdown/)
...
Might have useful code for some amazing features/figures.
...
# Knit into a PDF
To knit into a PDF, you don't need the .yml file. All you need is to do is to change the output format into "pdf_document" <br>
