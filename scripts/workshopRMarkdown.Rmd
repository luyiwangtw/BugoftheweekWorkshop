...
We will RMarkdown to create a webpage and publish the page as a GitHub page online.
...
# Knit into a PDF
To knit into a PDF, you don't need the .yml file. All you need to do is to change the output format into "pdf_document" <br>
...
However, there are some difference in syntax between the two formats and some functions are available for html output but not for PDF one, e.g. tabs, code buttons. So they are not completely compatible.
