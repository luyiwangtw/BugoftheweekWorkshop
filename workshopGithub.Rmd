...
<br>
<br>
__Repository__: One project. It can contain multiple scripts and data sets. <br>
__Clone__: Copy a repository to your computer so you can work on it. <br>
__Template__: A repository that contains useful code. You can clone it and modify it for your own project. Even if you clone a repository, the changes will not affect the original. <br>
__Push__: Upload your change sin GitHub. <br>
__Pull__: Download any changes you (or anybody else) did in a repository you have already cloned. i.e. Download form the internet to your computer. <br>
...
knitr::include_graphics("image/figure 1.png")
```
...
knitr::include_graphics("image/figure 2.png")
```
...
## Scenario 1:  Upload a repository that you created on your own GitHub account
...
### 1.1 Go to R studio and assign a project to your script
...
```{r, echo = FALSE, fig.cap = "Next, your app would look like this", out.width = '100%'}
knitr::include_graphics("image/figure 9.png")
```

### 1.4 Continue working on your file
...
knitr::include_graphics("image/figure 10.png")
```
...
knitr::include_graphics("image/figure 11.png")
```

### 1.5 Resolve version conflicts

_This is a parenthesis for troubleshooting_ <br>
...
```{r, echo = FALSE, out.width = '100%'}
knitr::include_graphics("image/figure 14.png")
```
...
## Scenario 2: Use a template repository from “bugoftheweek” 
...
```{r, echo = FALSE, out.width = '100%'}
knitr::include_graphics("image/figure 15.png")
```

```{r, echo = FALSE, fig.cap = "You will see this screen", out.width = '100%'}
knitr::include_graphics("image/figure 16.png")
```
...
### 2.2 Clone this template to work on it from your computer
...
```{r, echo = FALSE, out.width = '100%'}
knitr::include_graphics("image/figure 17.png")
```

```{r, echo = FALSE, out.width = '100%'}
knitr::include_graphics("image/figure 18.png")
```
...
### 2.3 One last bit to return knowledge to your dear lab-mates

Did you notice that all our repositories have a README file attached?

```{r, echo = FALSE, out.width = '100%'}
knitr::include_graphics("image/figure 19.png")
```
...
## Scenario 3: Modify a template repository and upload to “bugoftheweek”
...
### 3.1 Clone the template from the organization to work on it from your computer

Go to GitHub desktop. Select File - Clone repository -  Select the one you want to work on and indicate the folder on your computer where you want to send it to. 

```{r, echo = FALSE, out.width = '100%'}
knitr::include_graphics("image/figure 20.png")
```
